...
import (
	...
	"github.com/AliyunContainerService/image-syncer/pkg/dockerhelper/iolimits"
	"github.com/AliyunContainerService/image-syncer/pkg/dockerhelper/uploadreader"
...
func (d *dockerImageDestination) putOneSignature(url *url.URL, signature []byte) error {
	...
	case httpURLScheme, httpsURLScheme:
